  ...
  return (
    <div>
      ...
      <Carousel autoplay className="carousel">
        {carousel.map(e => {
          return <img src={e} className="carousel-img" alt="carousel" />;
        })}
      </Carousel>
      <div className="cards">
        <Card className="card">
        ...
        <Card className="card">
          <h1>Artemis Fowl</h1>
          <img src={ArtemisFowl} alt="Artemis Fowl" className="card-content" />
          <br />
        ...
        <Card className="card">
          <h1>Moby Dick</h1>
          <img src={MobyDick} alt="Moby Dick" className="card-content" />
          <br />
          <Link to="/" className="link">
            View Product
          </Link>
